...
/**
Optional string that the host app can use for tracking purposes.
 */
@property (nonatomic, strong, nullable) NSString* mediaIdentifier;

/**
Optional dictionary whose keys and values must be strings. The host app can use for tracking purposes.
 */
