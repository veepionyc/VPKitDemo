...
- (void)configureConstraints {
    ...
    [guides[1].bottomAnchor constraintEqualToAnchor:self.viewerPreview.topAnchor].active = YES;
    ...
    [guides[2].bottomAnchor constraintEqualToAnchor:self.editorPreview.topAnchor].active = YES;
